...
function init() {
    ...
    // textTexture = new THREE.TextureLoader().load('AdventurersBeware.png');
    textTexture = THREE.ImageUtils.loadTexture('https://raw.githubusercontent.com/rsboudreaux/jumajni-text/master/webgl-smoke/dist/AdventurersBeware.png');
